...
/**
 * Writes [buf] to the channel and flushes.
 *
 * Suspends until Netty confirms the write completed or fails.
 * The caller retains ownership of [buf] — release it after this call returns.
 */
fun Channel.write(buf: ByteBuf): None<ByteBuf> = None.defer {
    suspendCancellableCoroutine { continuation ->
        writeAndFlush(buf).addListener { future ->
